        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 py-4">
          ...
          <div className="md:col-span-5">
            ...
            <p className="leading-relaxed text-sm opacity-90">
              An integrated platform that allows you to easily and securely
              connect with doctors through live video sessions. We offer
              appointment booking, secure online payments, and reminders, fully
              committed to protecting your data.
            </p>
          </div>

          {/* ✅ Quick Links - 1/6 Width */}
          <div className="md:col-span-2 md:col-start-7 pt-6">
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  to="/"
                  className="hover:text-[#2F9650] hover:underline transition cursor-pointer"
                >
                  Home
                </Link>
              </li>
          ...
          <div className="md:col-span-2 md:col-start-10 pt-6">
            ...
            <ul className="space-y-2 text-sm opacity-90">
              ...
              <li className="flex items-center gap-2">
                ...
                <a
                  href="mailto:Dr.Now2025@gmail.com"
